...
class FourierConfig(PeftConfig):
    ...
    Args:
        n_frequency (`int`): IFFT frequency dimension.
    ...
    n_frequency: int = field(default=100, metadata={"help": ""})
    ...
    init_fourier_weights: bool | Literal["gaussian", "loftq"] = field(
        default=True,
        metadata={
            "help": (
                "How to initialize the weights of the fourier layers. Passing True (default) results in the default "
                "initialization from the reference implementation from Microsoft. Passing 'gaussian' results "
                "in Gaussian initialization scaled by the fourier rank for linear and layers. Setting the initialization "
